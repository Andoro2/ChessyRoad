...
public class Bishop_FullZigZag : MonoBehaviour
{
    ...
    public Vector3 GetPosition()
    {
        ...
        else // AvailablePositions.Count == 2
        {
            if (Side == 0)
            {
                if (AvailablePositions.Contains(AvailablePositions[Side]))
                {
                    NextPos = AvailablePositions[Side];
                    Side = 1;
                }
                else if (AvailablePositions.Contains(AvailablePositions[1]))
                {
                    NextPos = AvailablePositions[1];
                    Side = 1;
                }
                else
                {
